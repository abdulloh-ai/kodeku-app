    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl border border-slate-200 shadow-xl">
        <div className="text-center">
          <div className="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center text-white font-extrabold text-2xl mx-auto mb-3">
            k
          </div>
          <h2 className="text-2xl font-extrabold text-slate-900">
            Set Kredensial Akun Admin Anda
          </h2>
          <p className="mt-2 text-sm text-slate-600">
            Masukkan Nama, Email, dan Password pilihan Anda sendiri untuk akun Admin Kodemik.
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">
                Nama Lengkap Admin Anda
              </label>
              <input
                type="text"
                required
                placeholder="Masukkan Nama Anda (Owner)"
          ...
          >
            {loading ? 'Menyimpan Kredensial...' : 'Set Kredensial & Masuk Dashboard ➔'}
          </button>
        </form>

        <div className="text-center pt-2">
          <Link href="/admin/login" className="text-xs font-semibold text-blue-600 hover:underline">
            Sudah punya akun? Login Admin di sini
          </Link>
        </div>
      </div>
    </div>
